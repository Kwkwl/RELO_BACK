...
<h2> 주요 기능 </h2>
□ 사용자 페이지<br>
- 입찰 시스템 구현(구매입찰/판매입찰)<br>
- 상품별 최근/평균 가격 구현<br>
- SNS 와 같은 게시물(STYLE 게시판) 등록/수정 기능 구현<br>
- STYLE 게시판과 댓글에 좋아요/댓글 기능 구현<br>
- 해시태그 통한 게시물 필터링 구현<br>
- 마이페이지(프로필 정보 확인 및 수정)<br>
□ 관리자 페이지<br>
- 경매(낙찰) 관리<br>
- 배송현황 관리<br>
- 공지사항 관리(게시물 등록 및 수정, 삭제)<br>
- 상품관리(상품 등록 및 게시상태)<br>
